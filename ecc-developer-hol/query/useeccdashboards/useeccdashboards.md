...
"Order" value refinement to either replace the "Order" or click on the attribute name "Order" to add more orders to refine the page. 
...
3. In the Track and Trace dashboard, click on the side navigation panel to open Available refinements, by default "Inventory Trace Suppliers" is the selected dataset. 
...
5. Hold "control" key and click on all three sales orders from the diagram, then right click to view the pop up options.
